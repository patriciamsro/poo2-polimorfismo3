...
public class ProfessorMestre extends Professor{
	...
	public static final Integer PERCENTUAL_MAXIMO_BONUS = 30;
	public static final Integer VALOR_MAXIMO_BONUS = 3000;
	
	private Double bonus;

	public ProfessorMestre(String nome, String cpf, String endereco, String disciplina, Double salario) {
	...
	public String toString() {
		return "Professor(a) Mestre: " + getNome()
		+ " CPF: " + getCpf()
